...
output "aks_csi_identity_client_id" {
  description = "Client ID for SecretProviderClass - use this in GitOps manifests"
...
output "gitops_identity_reminder" {
  value = <<-EOT
    ...
    ============================================================
    WICHTIG: AKS Identity für SecretProviderClasses
    ============================================================

    Diese Identity muss in allen SecretProviderClass YAMLs verwendet werden:
    ...
    Die Customer-Module generieren das automatisch.
    Für manuelle Manifests (z.B. Grafana) diese Werte verwenden!
    ============================================================
  EOT
}
